...
state-slug mapping, the publisher-vs-distribution "two states" trap, and the
...
| **lebensmittelwarnung-regional** | Recalls for a specific Bundesland (name → slug), incl. the affected-states cross-check. | "aktuelle Lebensmittelwarnungen in Bayern?", "Rückrufe in NRW?", "betrifft das Hamburg?" |
